...
namespace SPFactory.Samples
{
    class Program
    {
        static void Main(string[] args)
        {
            WorkbookManager WorkbookManager = new global::SPFactory.Core.Factory.WorkbookManager();
            
            //Spreadsheet teste123 = new Spreadsheet();
            //teste123.SpreadsheetList = new List<Spreadsheet>();
            

            //Spreadsheet spf0 = GerarExemploFiltro(WorkbookManager);
            //spf0.Name = "teste 1";
            //teste123.SpreadsheetList.Add(spf0);
            //WorkbookManager.MountSpreadsheet(teste123);

            //WorkbookManager.SaveSpreadsheet("", DateTime.Now.ToString().Replace("/", "").Replace(":", "").Replace(" ", "") + ".xls");

            Spreadsheet spf1 = GerarExemplo(WorkbookManager);
            ...
            Spreadsheet spf2 = GerarExemploSemHeader(WorkbookManager);
            ...
            Spreadsheet teste = new Spreadsheet();
            teste.SpreadsheetList = new List<Spreadsheet>();
            spf1.Name = "teste 1";
            //spf1.MergedTitle = "titulo";
            ...
            teste.SpreadsheetList.Add(spf1);
            ...
            teste.SpreadsheetList.Add(spf2);
        ...
        static Spreadsheet GerarExemploFiltro(WorkbookManager WorkbookManager)
        {
            ...
            Spreadsheet spf = new Spreadsheet();
            spf.Header = header;
        ...
        static Spreadsheet GerarExemplo(WorkbookManager WorkbookManager)
        {
            Header header = new Header();
            header.AddFilter("Valor", 10.3);
            header.AddFilter("Nome", "italo");
            ...
            list.Add(new Pessoa() { Idade = 50, Nascimento = DateTime.Now, Nome = "Italo list", Salario = 2 });
            ...
            list2.Add(new Pessoa() { Idade = 12, Nascimento = DateTime.Now, Nome = "JOAO list2", Salario = 2 });
            ...
            list3.Add(new Pessoa() { Idade = 30, Nascimento = DateTime.Now, Nome = "JasdadasdasdOAO", Salario = 2 });
        ...
        static Spreadsheet GerarExemploSemHeader(WorkbookManager WorkbookManager)
        {
            Spreadsheet spf = new Spreadsheet();
